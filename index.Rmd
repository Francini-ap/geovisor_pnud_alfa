...
renderDT({
  ...
  registros %>%
    st_drop_geometry() %>%
    select(nom_abrev, mar_genero, nom_donant,presupu_2, ods) %>%
    datatable(
      rownames = FALSE,
      colnames = c(
     "Proyecto", 
...
<img src="https://francini-ap.github.io/capas_visor_tfg_2022/GeoVisorPNUD.png" alt="JuveYell" width="800px" height="400px">
</p>
</div>
</center>
...
<img src="https://francini-ap.github.io/capas_visor_tfg_2022/des2.png" alt="JuveYell" width="50px">
</p>
</div>
...
<br>
<button class="bt2"><a href='https://francini-ap.github.io/capas_visor_tfg_2022/alcances_geo.jpg'>Guía de uso sobre la información del área geográfica de los proyectos </a></button>

<style>
.btb{background-color:white;color:black;width:250px;}
</style>

<button class="bt2"><a href='https://francini-ap.github.io/capas_visor_tfg_2022/indica_geo.jpg'>Guía de uso de los Geovisores y sus herramientas disponibles </a></button>
